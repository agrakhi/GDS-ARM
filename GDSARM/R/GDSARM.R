...
#' with a differently set of \code{nint} randomly selected two-factor interactions.
...
GDSARM<- function(delta.n=10, nint, nrep, ntop,pkeep, design, Y,cri.penter=0.01, cri.premove=0.05,opt.heredity=c("none")){
  n = dim(design)[1]
  m = dim(design)[2]
